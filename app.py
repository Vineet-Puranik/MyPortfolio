...
obe2 = Image.open("images/obe2.png")
##header section
with st.container():
    st.markdown("""
    <style>
...
with st.container():
    ...
    with text_column:
        ...
        st.write(
            """
             Just got to campus? Are you overwhelmed by the shear amount of organizations?\n
             ...
             Check out the website, and receive a curated list of organizations based on our demands. Explore the organizations of your dreams right from your room!
            """
        )
    ...
    with image_column:
        ...
        with text_column:
            ...
            st.write(
                """
                Want to create your website! It'll be a process of trial and error, but I'll help you get there. \n
                Perfection takes time. Use Streamlit, the open-source python framework, to build and deliver an interactive data app. \n
                Follow this source code to develop a website for your  business, blog, portfolio, or any other purpose!
                """
            )
            st.markdown("[Take a look the code...](https://github.com/Vineet-Puranik/MyPortfolio)")
    with st.container():
        image_column, text_column = st.columns((1,2))
    with image_column:
        with image_column:
        ...
        with text_column:
            ...
            st.write(
                ...
                The website aimed to create an interactive platform with cohesive elements that present simple yet powerful information effectively.       
                """
            )
    ...
    with image_column:
        ...
        with text_column:
            ...
            st.write(
                ...
                As a product management intern at OBE, I worked on the architectural window lineup. To make the data-centric role of our PM's easier, I created a dashboard. \n
...
with st.container():
    ...
    with text_column:
        ...
        st.write(
            """
             ...
             - Enovis is a leading provider of advanced medical technology and orthopedic solutions, dedicated to improving patient outcomes, with a market cap of approximately $3.5 billion.\n
    ...
    with image_column:
        with image_column:
            st.image(obe2)
        with text_column:
            st.subheader("Oldcastle BuildingEnvelope")
            st.write(
                """
                 - From June 2024 to August 2024, I had the chance to work as product management intern at OBE.\n
                 - OBE is the leading supplier of value-added, glazing-focused products and services, specializing in designing, engineering, and manufacturing engineered solutions for buildings.\n
                 - As a product management intern, I optimized product management and strategic decision-making through data-driven insights and effective process improvements.   
                """
            )
            st.markdown("[Letter of Recommendation | Regan Axtell - Product Manager - AW & Glass](https://docs.google.com/document/d/1g1nsJnmpBGBvST5r-Urc-_EYAsfykPPA7n-vqtn8YNw/edit?usp=sharing)")    
